    ...
    <div className="space-y-16 pb-16">
      ...
      <div className="relative h-[70vh] overflow-hidden">
        ...
        <div className="relative z-20 container mx-auto px-4 h-full flex flex-col justify-center">
          <div className="max-w-2xl">
            ...
            <p className="text-xl text-white/90 mb-8">
              Explore comprehensive information about cities around the world,
              powered by our AI assistant that gives you accurate, up-to-date
              details.
            </p>
        ...
        <div className="absolute bottom-0 left-0 right-0 h-16 z-10">
          ...
          >
            <path
              d="M0 50L48 45.7C96 41.3 192 32.7 288 25.8C384 19 480 14 576 16.5C672 19 768 29 864 41.5C960 54 1056 69 1152 70.8C1248 72.7 1344 61.3 1392 55.7L1440 50V100H1392C1344 100 1248 100 1152 100C1056 100 960 100 864 100C768 100 672 100 576 100C480 100 384 100 288 100C192 100 96 100 48 100H0V50Z"
              fill="white"
            />
          </svg>
        </div>
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Our AI-powered platform provides accurate, up-to-date information
            about cities around the world, helping you make informed decisions.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600">
              Get detailed information about cost of living, culture,
              transportation, education, and more for cities worldwide.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600">
              Ask specific questions about any city and get instant, accurate
              responses powered by our governed AI system.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600">
              Compare multiple cities side by side to find the perfect match for
              your lifestyle, career, or travel plans.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-blue-500 to-teal-500 py-16 rounded-xl">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 text-xl max-w-2xl mx-auto mb-8">
            Start your journey today and discover everything you need to know
            about cities around the world.
          </p>
          <Button
            size="lg"
            onClick={() => navigate("/cities")}
